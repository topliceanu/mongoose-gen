/*jshint forin:true, noempty:true, eqeqeq:true, bitwise:true, strict:true, undef:true, node:true, indent:4, maxerr:50, globalstrict:true */
...
var check = function (type, value) {
	if (type === 'match') {
		if (!util.is('String', value)) throw new Error('value for '+key+' should be string');
